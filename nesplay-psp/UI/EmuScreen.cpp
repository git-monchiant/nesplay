...
void EmuScreen::bootComplete() {
	...
	if (GetGPUBackend() == GPUBackend::OPENGL) {
		...
		if (g_Config.bGfxDebugOutput) {
			g_OSD.Show(OSDType::MESSAGE_WARNING, "WARNING: GfxDebugOutput is enabled via nesplay_psp.ini. Things may be slow.", 10.0f);
		}
	}
#endif
...
#if NESPLAY_PSP_PLATFORM(WINDOWS) || defined(USING_QT_UI) || defined(SDL)
