...
private:
	...
	void OnExitApp(UI::EventParams &e);
	void HandleL2(bool pressed);

	// L2/Esc dismiss: require a full release + time debounce before accepting dismiss.
	bool dismissInputReleased_ = false;
	bool needsFocusBack_ = false;
	...
	void CreateSaveStateSettings(UI::ViewGroup *saveStateSettings);
