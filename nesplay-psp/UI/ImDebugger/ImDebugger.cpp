...
static void DrawInternals(ImConfig &cfg) {
	if (!ImGui::Begin("nesplay-psp Internals", &cfg.internalsOpen)) {
		ImGui::End();
		return;
	}
	...
	if (ImGui::BeginMainMenuBar()) {
		...
		if (ImGui::BeginMenu("Symbols")) {
			...
			if (ImGui::MenuItem("Load .ppmap...")) {
				System_BrowseForFile(reqToken_, "Load NESPLAY_PSP symbol map", BrowseFileType::SYMBOL_MAP, [&](const char *responseString, int) {
			...
			if (ImGui::MenuItem("Save .ppmap...")) {
				System_BrowseForFileSave(reqToken_, "Save NESPLAY_PSP symbol map", "symbols.ppmap", BrowseFileType::SYMBOL_MAP, [](const char *responseString, int) {
					Path path(responseString);
		...
		if (ImGui::BeginMenu("Misc")) {
			ImGui::MenuItem("nesplay-psp Internals", nullptr, &cfg_.internalsOpen);
