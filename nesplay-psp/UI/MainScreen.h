...
public:
	...
	bool IsLoaded() const { return !listingPending_; }
	void FocusFirstGame();
...
protected:
	...
	void OnNESPLAY_PSPOrg(UI::EventParams &e);
	...
	// L2/Esc opens settings (pushes GameSettingsScreen)
	bool l2WasDown_ = false;
	void HandleL2(bool pressed);
	void OpenSettings();

	// Auto-focus first game after browser finishes loading
	bool needsAutoFocus_ = true;
