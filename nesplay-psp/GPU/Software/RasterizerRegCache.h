...
#if defined(_MSC_VER) && NESPLAY_PSP_ARCH(ARM64)
...
#if NESPLAY_PSP_ARCH(AMD64) && NESPLAY_PSP_PLATFORM(WINDOWS) && (defined(_MSC_VER) || defined(__clang__) || defined(__INTEL_COMPILER))
