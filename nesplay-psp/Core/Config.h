...
extern const char *NESPLAY_PSP_GIT_VERSION;
...
public:
	...
	std::string sFailedGPUBackends;  // NOT stored in nesplay_psp.ini anymore!
	...
	// Still, we may wanna store it more securely than in NESPLAY_PSP.ini, especially on Android.
