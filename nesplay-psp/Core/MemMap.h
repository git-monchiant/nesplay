...
// NESPLAY_PSP is very aggressive about trying to do memory accesses directly, for speed.
...
#if NESPLAY_PSP_ARCH(32BIT) || NESPLAY_PSP_PLATFORM(UWP) || USE_ASAN || NESPLAY_PSP_PLATFORM(IOS) || defined(__EMSCRIPTEN__)
