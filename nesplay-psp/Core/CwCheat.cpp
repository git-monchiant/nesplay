...
// Cache invalidation
//
// It should be obvious why we need to invalidate the instruction cache (effectively, in NESPLAY_PSP's case,
...
CheatOperation CWCheatEngine::InterpretNextCwCheat(const CheatCode &cheat, size_t &i) {
	...
	case 0xA: // NESPLAY_PSP specific cheats
		...
		// Place for other NESPLAY_PSP specific cheats
		default:
			return { CheatOp::Invalid };
		}
