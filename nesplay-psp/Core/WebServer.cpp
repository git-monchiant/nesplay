...
static const char *REPORT_HOSTNAME = "report.nesplay_psp.org";
...
// This reports the local IP address to report.nesplay_psp.org, which can then
...
static bool RegisterServer(int port) {
	...
	http.SetUserAgent(StringFromFormat("NESPLAY_PSP/%s", NESPLAY_PSP_GIT_VERSION));
