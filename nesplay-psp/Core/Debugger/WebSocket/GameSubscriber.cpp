// Copyright (c) 2018- NESPLAY_PSP Project.
...
//
// Response (same event name):
//  - name: string, "NESPLAY_PSP" unless some special build.
...
void WebSocketVersion(DebuggerRequest &req) {
	...
	json.writeString("name", "NESPLAY_PSP");
	json.writeString("version", NESPLAY_PSP_GIT_VERSION);
}
