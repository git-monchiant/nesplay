...
static int sceMd5Digest(u32 dataAddr, u32 len, u32 digestAddr) {
	...
	nesplay_psp_md5(Memory::GetPointerWriteUnchecked(dataAddr), (int)len, Memory::GetPointerWriteUnchecked(digestAddr));
	return 0;
}
...
static int sceMd5BlockInit(u32 ctxAddr) {
	...
	nesplay_psp_md5_starts(&md5_ctx);
	return 0;
}
...
static int sceMd5BlockUpdate(u32 ctxAddr, u32 dataPtr, u32 len) {
	...
	nesplay_psp_md5_update(&md5_ctx, Memory::GetPointerWriteUnchecked(dataPtr), (int)len);
	return 0;
}
...
static int sceMd5BlockResult(u32 ctxAddr, u32 digestAddr) {
	...
	nesplay_psp_md5_finish(&md5_ctx, Memory::GetPointerWriteUnchecked(digestAddr));
	return 0;
}
