...
int DoBlockingPdpRecv(AdhocSocketRequest& req, s64& result) {
	...
	//       We may also need to implement encryption (or a simple checksum will do) in order to validate the packet to findout whether it came from NESPLAY_PSP or a different App that may be sending/broadcasting data to the same port being used by a game
	...
	// At this point we assumed that the packet is a valid NESPLAY_PSP packet
...
const HLEFunction sceNetAdhoc[] = {
	...
	// Fake function for NESPLAY_PSP's use.
