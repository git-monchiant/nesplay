...
// https://github.com/hrydgard/nesplay_psp/issues/1078
...
static u32 sceSasSetVoice(u32 core, int voiceNum, u32 vagAddr, int size, int loop) {
	...
	if (size < 0) {
		...
		// Needs more rigorous testing perhaps, but this fixes issue https://github.com/hrydgard/nesplay_psp/issues/5652
