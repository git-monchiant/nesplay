...
enum TMIDType : int {
	...
	NESPLAY_PSP_KERNEL_TMID_Module          = 0x100001,
	NESPLAY_PSP_KERNEL_TMID_PMB             = 0x100002,
	NESPLAY_PSP_KERNEL_TMID_File            = 0x100003,
	NESPLAY_PSP_KERNEL_TMID_DirList         = 0x100004,
	NESPLAY_PSP_KERNEL_TMID_Heap            = 0x100005,
};
