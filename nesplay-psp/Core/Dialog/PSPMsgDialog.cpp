...
int PSPMsgDialog::Update(int animSpeed) {
	...
	if (flag & (DS_ERROR | DS_ABORT)) {
		...
		// Auto-dismiss all message dialogs: auto-select Yes for Yes/No, OK for OK, Back for others
		messageDialog.buttonPressed = (flag & DS_YESNO) ? 1 : (flag & DS_VALIDBUTTON) ? 1 : 0;
