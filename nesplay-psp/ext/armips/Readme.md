...
#### `-sym2 <filename>`
Specifies the output name for symbol data in the sym2 format. This format is supported by the debuggers in PCSX2 and NESPLAY_PSP. Example output:
```
00000000 0
80000000 .dbl:0010
80000010 Main
...
* Version 0.9
    ...
    * new `-sym2` format for use with NESPLAY_PSP and PCSX2
