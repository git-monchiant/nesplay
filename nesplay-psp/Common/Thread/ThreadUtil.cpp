...
#if (NESPLAY_PSP_PLATFORM(ANDROID) || NESPLAY_PSP_PLATFORM(LINUX)) && !defined(_GNU_SOURCE)
#define _GNU_SOURCE
#endif
...
#elif NESPLAY_PSP_PLATFORM(ANDROID) || NESPLAY_PSP_PLATFORM(LINUX)
...
#elif NESPLAY_PSP_PLATFORM(MAC) || NESPLAY_PSP_PLATFORM(IOS)
	uint64_t tid = 0;
