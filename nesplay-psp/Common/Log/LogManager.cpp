...
#if NESPLAY_PSP_PLATFORM(UWP) && defined(_DEBUG)
...
#if NESPLAY_PSP_PLATFORM(IOS) || NESPLAY_PSP_PLATFORM(UWP) || NESPLAY_PSP_PLATFORM(SWITCH)
...
#if NESPLAY_PSP_PLATFORM(ANDROID)
#ifndef LOG_APP_NAME
#define LOG_APP_NAME "NESPLAY_PSP"
#endif
	int mode;
