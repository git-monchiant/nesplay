...
#if !NESPLAY_PSP_PLATFORM(IOS_APP_STORE)
// Putting our own Vulkan function pointers in a namespace ensures that nesplay_psp_libretro.so doesn't collide with libvulkan.so.
...
#endif  // !NESPLAY_PSP_PLATFORM(IOS_APP_STORE)
} // namespace NESPLAY_PSP_VK
