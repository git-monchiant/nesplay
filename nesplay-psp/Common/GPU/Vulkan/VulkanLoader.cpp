// Copyright (c) 2016- NESPLAY_PSP Project.
...
#if !NESPLAY_PSP_PLATFORM(WINDOWS) && !NESPLAY_PSP_PLATFORM(SWITCH)
#include <dlfcn.h>
#endif
...
using namespace NESPLAY_PSP_VK;
