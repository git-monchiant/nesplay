...
OpenGLContext::OpenGLContext(bool canChangeSwapInterval) : renderManager_(frameTimeHistory_) {
	...
	if (!gl_extensions.VersionGEThan(3, 0, 0)) {
		...
		// Also on Intel, see https://github.com/hrydgard/nesplay_psp/issues/10117
	...
	if (caps_.vendor == GPUVendor::VENDOR_IMGTEC) {
		// See https://github.com/hrydgard/nesplay_psp/commit/8974cd675e538f4445955e3eac572a9347d84232
	...
	if (caps_.vendor == GPUVendor::VENDOR_QUALCOMM) {
		...
		// See https://github.com/hrydgard/nesplay_psp/issues/16015#issuecomment-1328316080.
