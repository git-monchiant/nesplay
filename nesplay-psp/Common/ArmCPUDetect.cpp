...
#if NESPLAY_PSP_ARCH(ARM) || NESPLAY_PSP_ARCH(ARM64)
...
void CPUInfo::Detect()
{
...
#else // !NESPLAY_PSP_PLATFORM(IOS) && !NESPLAY_PSP_PLATFORM(MAC) && !NESPLAY_PSP_PLATFORM(WINDOWS)
	strcpy(brand_string, "Unknown");
	num_cores = 1;
#endif
	...
	bFP = false;
	bASIMD = false;
#else // NESPLAY_PSP_PLATFORM(LINUX)
...
#if NESPLAY_PSP_ARCH(ARM) && defined(USE_CPU_FEATURES)
...
#endif
#if NESPLAY_PSP_ARCH(ARM64) && defined(USE_CPU_FEATURES)
...
#endif // NESPLAY_PSP_ARCH(ARM) || NESPLAY_PSP_ARCH(ARM64)
