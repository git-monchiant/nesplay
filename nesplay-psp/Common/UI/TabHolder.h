...
public:
	...
	Choice *AddBack(UIScreen *parent);
	...
	void SetAutoSelectOnFocus(bool autoSelect);
...
public:
	...
	void SetAutoSelectOnFocus(bool autoSelect) { autoSelectOnFocus_ = autoSelect; }
