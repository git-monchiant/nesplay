...
// To run the NESPLAY_PSP core, a platform needs to implement all the System_ functions in this file.
...
// Going forward, "optional" things (NESPLAY_PSP will still function alright without it) will be requests,
...
// the other stuff, and this is only used by NESPLAY_PSP, so... better this than ugly strings.
