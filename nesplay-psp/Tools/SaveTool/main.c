...
PSP_MODULE_INFO("nesplay_pspsavetool", 0, 1, 0);
...
char *menuList1[] = {"ms0:/PSP/SAVEDATANESPLAY_PSP/","host0:/","host1:/", "host2:/", "Back", NULL};
...
int main(int argc, char *argv[])
{
	...
	for(;;)
	{
		...
		case 1:
			{
				int maxOption = 0;
				printf("NESPLAY_PSP Decrypted Save Directory : \n");
